...
def reapply():
    ...
    cmNodes = cmds.colorManagementPrefs(query=True, colorManagedNodes=True) + cmds.ls(type='mentalrayIblShape')
    ...
    for nodeName in cmNodes:
        ...
        cmds.setAttr(nodeName + '.colorSpace', colorSpace, type='string')# Copyright (C) 1997-2014 Autodesk, Inc., and/or its licensors.
# All rights reserved.
#
